...
export function Phase5Summary() {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="text-2xl">Phase 5 Vocabulary Expansion</CardTitle>
        <CardDescription>10 new words added (words 101-110)</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Badge variant="outline">Abstract Concepts</Badge>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <div>
                ...
                {phase5Words.filter((w) => w.difficulty === "beginner").length} words
              </div>
              <div>
                <span className="font-medium">Intermediate:</span>{" "}
                {phase5Words.filter((w) => w.difficulty === "intermediate").length} words
              </div>
              <div>
                <span className="font-medium">Advanced:</span>{" "}
                {phase5Words.filter((w) => w.difficulty === "advanced").length} words
              </div>
            </div>
          </div>
        </div>
