...
//cutting out repeated questions and adding new ones
    ...
    },
    {
      ...
      options: [
        ...
        { id: "b", text: "So run upon its meadows", isCorrect: false },
        { id: "c", text: "So walk upon its paths", isCorrect: true },
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "Are you secure that He will send you blessings from the heaven?", isCorrect: false },
        {
          id: "b", text: "Do you feel secure that He who [holds authority] in the heaven would not send against you a storm of stones?",
          isCorrect: true,
        },
        { id: "c", text: "Are you certain that He will protect you from the sky?", isCorrect: false },
        { id: "d", text: "Do you trust that He will guide you from above?", isCorrect: false },
      ],
      explanation:
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "And you will know how My guidance is clear", isCorrect: false },
        { id: "b", text: "And you will understand how severe My mercy is", isCorrect: false },
        { id: "c", text: "Then you would know how [severe] was My warning", isCorrect: true },
        { id: "d", text: "And you will see how powerful My creation is", isCorrect: false },
      ],
      explanation:
    ...
    },
    {
      ...
      explanation: "قُلْ إِنَّمَا أَنَا نَذِيرٌ (Qul innama ana nadhir) means 'Say: I am only a warner,' roots ق-و-ل (say) and ن-ذ-ر (warn) (Quran.com, Ibn Kathir).",
        ...
        {
      id: "q50",
      question: "What does the Arabic phrase 'فَلَمَّا رَأَوْهُ زُلْفَةً' mean?",
      arabic: "فَلَمَّا رَأَوْهُ زُلْفَةً",
      rootLetters: "ر أ ي | ز ل ف",
      options: [
        { id: "a", text: "But when they see it approaching", isCorrect: true },
        { id: "b", text: "But when they see it distant", isCorrect: false },
        { id: "c", text: "But when they see it fading", isCorrect: false },
        { id: "d", text: "But when they see it hidden", isCorrect: false },
      ],
      explanation: "فَلَمَّا رَأَوْهُ زُلْفَةً (Falamma ra'awhu zulfatan) means 'But when they see it approaching,' roots ر-أ-ي (see) and ز-ل-ف (approaching/near) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q51",
      question: "What does the Arabic phrase 'سِيئَتْ وُجُوهُ الَّذِينَ كَفَرُوا' mean?",
      arabic: "سِيئَتْ وُجُوهُ الَّذِينَ كَفَرُوا",
      rootLetters: "س و ء | و ج ه | ك ف ر",
      options: [
        { id: "a", text: "The faces of those who believed will be brightened", isCorrect: false },
        { id: "b", text: "The faces of those who disbelieved will be darkened", isCorrect: true },
        { id: "c", text: "The faces of those who disbelieved will be illuminated", isCorrect: false },
        { id: "d", text: "The faces of those who believed will be covered", isCorrect: false },
      ],
      explanation: "سِيئَتْ وُجُوهُ الَّذِينَ كَفَرُوا (Si'at wujuhu alladhina kafaru) means 'The faces of those who disbelieved will be darkened,' roots س-و-ء (darkened/grieved), و-ج-ه (faces), ك-ف-ر (disbelieved) (MyIslam, Al-Maududi).",
    },
    {
      id: "q52",
      question: "What does the Arabic phrase 'وَقِيلَ هَٰذَا الَّذِي كُنتُم بِهِ تَدَّعُونَ' mean?",
      arabic: "وَقِيلَ هَٰذَا الَّذِي كُنتُم بِهِ تَدَّعُونَ",
      rootLetters: "ق و ل | د ع و",
      options: [
        { id: "a", text: "And it will be said, 'This is what you used to deny'", isCorrect: false },
        { id: "b", text: "And it will be said, 'This is what you used to claim'", isCorrect: true },
        { id: "c", text: "And it will be said, 'This is what you used to fear'", isCorrect: false },
        { id: "d", text: "And it will be said, 'This is what you used to hope for'", isCorrect: false },
      ],
      explanation: "وَقِيلَ هَٰذَا الَّذِي كُنتُم بِهِ تَدَّعُونَ (Wa qila hadha alladhi kuntum bihi tadda'un) means 'And it will be said, 'This is what you used to claim',' roots ق-و-ل (said) and د-ع-و (claim) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q53",
      question: "What does the Arabic phrase 'قُلْ أَرَأَيْتُمْ إِنْ أَهْلَكَنِيَ اللَّهُ' mean?",
      arabic: "قُلْ أَرَأَيْتُمْ إِنْ أَهْلَكَنِيَ اللَّهُ",
      rootLetters: "ق و ل | ر أ ي | ه ل ك",
      options: [
        { id: "a", text: "Say: Have you considered if Allah should destroy me", isCorrect: true },
        { id: "b", text: "Say: Have you considered if Allah should save me", isCorrect: false },
        { id: "c", text: "Say: Have you considered if Allah should guide me", isCorrect: false },
        { id: "d", text: "Say: Have you considered if Allah should honor me", isCorrect: false },
      ],
      explanation: "قُلْ أَرَأَيْتُمْ إِنْ أَهْلَكَنِيَ اللَّهُ (Qul ara'aytum in ahlakaniya Allahu) means 'Say: Have you considered if Allah should destroy me,' roots ق-و-ل (say), ر-أ-ي (considered), ه-ل-ك (destroy) (MyIslam, Al-Maududi).",
    },
    {
      id: "q54",
      question: "What does the Arabic phrase 'وَمَن مَّعِيَ أَوْ رَحِمَنَا' mean?",
      arabic: "وَمَن مَّعِيَ أَوْ رَحِمَنَا",
      rootLetters: "م ع | ر ح م",
      options: [
        { id: "a", text: "And those with me or if He should punish us", isCorrect: false },
        { id: "b", text: "And those with me or if He should have mercy on us", isCorrect: true },
        { id: "c", text: "And those against me or if He should forgive us", isCorrect: false },
        { id: "d", text: "And those near me or if He should guide us", isCorrect: false },
      ],
      explanation: "وَمَن مَّعِيَ أَوْ رَحِمَنَا (Wa man ma'iya aw rahimana) means 'And those with me or if He should have mercy on us,' roots م-ع (with) and ر-ح-م (mercy) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q55",
      question: "What does the Arabic phrase 'فَمَن يُجِيرُ الْكَافِرِينَ مِنْ عَذَابٍ أَلِيمٍ' mean?",
      arabic: "فَمَن يُجِيرُ الْكَافِرِينَ مِنْ عَذَابٍ أَلِيمٍ",
      rootLetters: "ج و ر | ك ف ر | ع ذ ب | أ ل م",
      options: [
        { id: "a", text: "Then who can protect the disbelievers from a painful punishment?", isCorrect: true },
        { id: "b", text: "Then who can guide the disbelievers to a great reward?", isCorrect: false },
        { id: "c", text: "Then who can save the believers from a severe torment?", isCorrect: false },
        { id: "d", text: "Then who can grant the disbelievers a lasting mercy?", isCorrect: false },
      ],
      explanation: "فَمَن يُجِيرُ الْكَافِرِينَ مِنْ عَذَابٍ أَلِيمٍ (Faman yujiru al-kafirina min 'adhabin alim) means 'Then who can protect the disbelievers from a painful punishment?' roots ج-و-ر (protect), ك-ف-ر (disbelievers), ع-ذ-ب (punishment), أ-ل-م (painful) (MyIslam, Al-Maududi).",
    },
    {
      id: "q56",
      question: "What does the Arabic phrase 'قُلْ هُوَ الرَّحْمَٰنُ آمَنَّا بِهِ' mean?",
      arabic: "قُلْ هُوَ الرَّحْمَٰنُ آمَنَّا بِهِ",
      rootLetters: "ق و ل | ر ح م | أ م ن",
      options: [
        { id: "a", text: "Say: He is the Most Merciful; we have believed in Him", isCorrect: true },
        { id: "b", text: "Say: He is the Most Powerful; we have trusted in Him", isCorrect: false },
        { id: "c", text: "Say: He is the Most Wise; we have obeyed Him", isCorrect: false },
        { id: "d", text: "Say: He is the Most High; we have submitted to Him", isCorrect: false },
      ],
      explanation: "قُلْ هُوَ الرَّحْمَٰنُ آمَنَّا بِهِ (Qul huwa ar-rahmanu amanna bihi) means 'Say: He is the Most Merciful; we have believed in Him,' roots ق-و-ل (say), ر-ح-م (Most Merciful), أ-م-ن (believed) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q57",
      question: "What does the Arabic phrase 'وَعَلَيْهِ تَوَكَّلْنَا' mean?",
      arabic: "وَعَلَيْهِ تَوَكَّلْنَا",
      rootLetters: "و ك ل",
      options: [
    ...
    {
      id: "q58",
      question: "What does the Arabic phrase 'فَسَتَعْلَمُونَ مَنْ هُوَ فِي ضَلَالٍ مُّبِينٍ' mean?",
      arabic: "فَسَتَعْلَمُونَ مَنْ هُوَ فِي ضَلَالٍ مُّبِينٍ",
      rootLetters: "ع ل م | ض ل ل | ب ي ن",
      options: [
        { id: "a", text: "And you will soon know who is in clear error", isCorrect: true },
        { id: "b", text: "And you will soon know who is in pure guidance", isCorrect: false },
        { id: "c", text: "And you will soon know who is in open truth", isCorrect: false },
        { id: "d", text: "And you will soon know who is in lasting success", isCorrect: false },
      ],
      explanation: "فَسَتَعْلَمُونَ مَنْ هُوَ فِي ضَلَالٍ مُّبِينٍ (Fasata'lamuna man huwa fi dalalin mubin) means 'And you will soon know who is in clear error,' roots ع-ل-م (know), ض-ل-ل (error), ب-ي-ن (clear) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q59",
      ...
      rootLetters: "ق و ل | ر أ ي | ص ب ح | م و ء | غ و ر",
      options: [
        { id: "a", text: "Say: Have you considered if your water should become sunken", isCorrect: true },
        { id: "b", text: "Say: Have you considered if your water should become abundant", isCorrect: false },
        { id: "c", text: "Say: Have you considered if your water should become pure", isCorrect: false },
        { id: "d", text: "Say: Have you considered if your water should become flowing", isCorrect: false },
      ],
      explanation: "قُلْ أَرَأَيْتُمْ إِنْ أَصْبَحَ مَاؤُكُمْ غَوْرًا (Qul ara'aytum in asbaha ma'ukum ghawran) means 'Say: Have you considered if your water should become sunken,' roots ق-و-ل (say), ر-أ-ي (considered), ص-ب-ح (become), م-و-ء (water), غ-و-ر (sunken) (MyIslam, Al-Maududi).",
    },
    {
      id: "q60",
      question: "What does the Arabic phrase 'فَمَن يَأْتِيكُم بِمَاءٍ مَّعِينٍ' mean?",
      arabic: "فَمَن يَأْتِيكُم بِمَاءٍ مَّعِينٍ",
      rootLetters: "أ ت ي | م و ء | ع ي ن",
      options: [
        { id: "a", text: "Then who could bring you flowing water?", isCorrect: true },
        { id: "b", text: "Then who could bring you pure water?", isCorrect: false },
        { id: "c", text: "Then who could bring you salty water?", isCorrect: false },
        { id: "d", text: "Then who could bring you rain water?", isCorrect: false },
      ],
      explanation: "فَمَن يَأْتِيكُم بِمَاءٍ مَّعِينٍ (Faman ya'tikum bima'in ma'in) means 'Then who could bring you flowing water?' roots أ-ت-ي (bring), م-و-ء (water), ع-ي-ن (flowing/spring) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q61",
