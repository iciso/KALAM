export const alMulkQuizData: SurahQuizData = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "Blessed is He in whose hand is the dominion", isCorrect: true },
...
{
  id: "q27",
  question: "What does the Arabic phrase 'جَعَلَ لَكُمُ الْأَرْضَ ذَلُولًا' mean (from verse 67:15)?",
  arabic: "جَعَلَ لَكُمُ الْأَرْضَ ذَلُولًا",
  rootLetters: "ج ع ل | أ ر ض | ذ ل ل",
  options: [
    { id: "a", text: "Made the earth difficult for you", isCorrect: false },
    { id: "b", text: "Made the earth submissive for you", isCorrect: true },
    { id: "c", text: "Made the earth flat for you", isCorrect: false },
    { id: "d", text: "Made the earth fertile for you", isCorrect: false },
  ],
  explanation:
