export const alMulkQuizData: SurahQuizData = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "Its keepers ask them", isCorrect: true },
        { id: "b", text: "Its angels greet them", isCorrect: false },
        { id: "c", text: "Its denizens ask them", isCorrect: false },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "b", text: "But we believed and said, 'Allah knows when the Hour is'", isCorrect: false },
        { id: "c", text: "But we accepted and said, 'Allah understands the things sent'", isCorrect: false },
        { id: "d", text: "But we questioned and said, 'We fear the revealation sent", isCorrect: false },
      ],
      explanation: "فَكَذَّبۡنَا وَقُلۡنَا مَا نَزَّلَ ٱللَّهُ مِن شَيۡءٍ (Fakazzabnaa wa qulnaa maa nazzalal laahu min shai in) means 'But we denied and said, 'We do not know what the Hour is',' roots ك-ذ-ب (denied), ق-و-ل (said), د-ر-ي (know), س-و-ع (Hour) (MyIslam, Al-Maududi).",
    },
    {
      id: "q25",
