...
export const alMulkQuizData: SurahQuizData = {
  ...
  questions: [
    ...
    },
    {
      ...
      explanation:
        "أَوْ يُسْكِنْكُمْ فِيهَا رِيحًا (Aw yuskin kum fiha rihan) means 'Or send upon you a wind,' roots س-ك-ن (send) and ر-ي-ح (wind) (MyIslam, Al-Maududi).",
    },
    {
      id: "q25",
      question: "What does the Arabic phrase 'وَهُوَ الْعَزِيزُ الرَّحِيمُ' mean?",
      ...
      explanation:
        "وَهُوَ الْعَزِيزُ الرَّحِيمُ (Wa huwa al-'azizu ar-rahim) means 'And He is the Almighty, the Merciful,' roots ع-ز-ز (Almighty) and ر-ح-م (Merciful) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q26",
      question: "What does the Arabic phrase 'فَٱعۡتَرَفُواْ بِذَنۢبِهِمۡ فَسُحۡقٗا لِّأَصۡحَٰبِ ٱلسَّعِيرِ' mean?",
      arabic: "فَٱعۡتَرَفُواْ بِذَنۢبِهِمۡ فَسُحۡقٗا لِّأَصۡحَٰبِ ٱلسَّعِيرِ",
      rootLetters: "ع ت ر ف | ذ ن ب | س ح ق | أ ص ح ب",
      options: [
        { id: "a", text: "So they denied and said Allah sent down nothing", isCorrect: false },
        {
          id: "b",
          text: "And they admitted their sin, so alienation for the companions of the Blaze",
          isCorrect: true,
        },
        {
          id: "c",
          text: "And they concealed their guilt, so forgiveness for the companions of Paradise",
          isCorrect: false,
        },
        { id: "d", text: "And they rejected their Lord, so peace for the companions of the Fire", isCorrect: false },
      ],
      explanation:
        "فَٱعۡتَرَفُواْ بِذَنۢبِهِمۡ فَسُحۡقٗا لِّأَصۡحَٰبِ ٱلسَّعِيرِ (Fa'atarafu bidhanbihim fasuḥqan li-aṣḥābi as-sa'īr) means 'And they admitted their sin, so alienation/ruin for the companions of the Blaze,' from Surah Al-Mulk 67:11. Roots: ع-ت-ر-ف (admitted), ذ-ن-ب (sin), س-ح-ق (ruin/alienation), أ-ص-ح-ب (companions). This verse describes the disbelievers admitting their sins on the Day of Judgment and facing the consequence of being distanced from mercy (MyIslam.org 67:17, Quran.com, Ibn Kathir, Al-Maududi)",
    },
    {
      id: "q27",
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: "b",
          text: "Do you feel secure that He who [holds authority] in the heaven would not send against you a storm of stones?",
          isCorrect: true,
        },
