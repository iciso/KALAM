  ...
  questions: [
    ...
    },
    {
      ...
      explanation: "قُلْ إِنَّمَا أَنَا نَذِيرٌ (Qul innama ana nadhir) means 'Say: I am only a warner,' roots ق-و-ل (say) and ن-ذ-ر (warn) (Quran.com, Ibn Kathir).",
       ...
       {
      id: "q48",
      question: "What does the Arabic phrase 'وَمَا مِنْ إِلَٰهٍ إِلَّا اللَّهُ الْوَاحِدُ الْقَهَّارُ' mean?",
      arabic: "وَمَا مِنْ إِلَٰهٍ إِلَّا اللَّهُ الْوَاحِدُ الْقَهَّارُ",
      rootLetters: "إ ل ه | ل ه | و ح د | ق ه ر",
      options: [
        { id: "a", text: "And there is no deity except Allah, the One, the Compeller", isCorrect: false },
        { id: "b", text: "And there is no god but Allah, the One, the Subduer", isCorrect: false },
        { id: "c", text: "And there is no deity except Allah, the One, the Almighty", isCorrect: false },
        { id: "d", text: "And there is no deity except Allah, the One, the Subjugator", isCorrect: true },
      ],
      explanation: "وَمَا مِنْ إِلَٰهٍ إِلَّا اللَّهُ الْوَاحِدُ الْقَهَّارُ (Wa ma min ilahin illa Allahu al-Wahidu al-Qahhar) means 'And there is no deity except Allah, the One, the Subjugator,' roots إ-ل-ه (deity), ل-ه (Allah), و-ح-د (one), ق-ه-ر (subjugate) (MyIslam, Al-Maududi).",
    },
    {
      id: "q49",
      question: "What does the Arabic phrase 'رَبِّ السَّمَاوَاتِ وَالْأَرْضِ' mean?",
      arabic: "رَبِّ السَّمَاوَاتِ وَالْأَرْضِ",
      rootLetters: "ر ب ب | س م و | أ ر ض",
      options: [
        { id: "a", text: "Creator of the heavens and earth", isCorrect: false },
        { id: "b", text: "Lord of the heavens and earth", isCorrect: true },
        { id: "c", text: "Master of the heavens and earth", isCorrect: false },
        { id: "d", text: "Owner of the heavens and earth", isCorrect: false },
      ],
      explanation: "رَبِّ السَّمَاوَاتِ وَالْأَرْضِ (Rabb as-samawati wal-ard) means 'Lord of the heavens and earth,' roots ر-ب-ب (Lord), س-م-و (heavens), أ-ر-ض (earth) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q50",
      question: "What does the Arabic phrase 'وَما يَذْكُرُونَ إِلَّا أَن يَشَاءَ اللَّهُ' mean?",
      arabic: "وَما يَذْكُرُونَ إِلَّا أَن يَشَاءَ اللَّهُ",
      rootLetters: "ذ ك ر | ش ي ء | ل ه",
      options: [
        { id: "a", text: "And they will not remember except that Allah wills", isCorrect: true },
        { id: "b", text: "And they will not understand except that Allah wills", isCorrect: false },
        { id: "c", text: "And they will not believe except that Allah wills", isCorrect: false },
        { id: "d", text: "And they will not accept except that Allah wills", isCorrect: false },
      ],
      explanation: "وَما يَذْكُرُونَ إِلَّا أَن يَشَاءَ اللَّهُ (Wa ma yadhkuruna illa an yasha'a Allah) means 'And they will not remember except that Allah wills,' roots ذ-ك-ر (remember), ش-ي-ء (will), ل-ه (Allah) (MyIslam, Al-Maududi).",
    },
    {
      id: "q51",
      question: "What does the Arabic phrase 'هُوَ أَهْلُ التَّقْوَىٰ' mean?",
      arabic: "هُوَ أَهْلُ التَّقْوَىٰ",
      rootLetters: "أ ه ل | و ق ي",
      options: [
        { id: "a", text: "He is worthy of fear", isCorrect: false },
        { id: "b", text: "He is worthy of reverence", isCorrect: true },
        { id: "c", text: "He is worthy of worship", isCorrect: false },
        { id: "d", text: "He is worthy of obedience", isCorrect: false },
      ],
      explanation: "هُوَ أَهْلُ التَّقْوَىٰ (Huwa ahl at-taqwa) means 'He is worthy of reverence,' roots أ-ه-ل (worthy) and و-ق-ي (reverence) (Quran.com, Ibn Kathir).",
    },
    {
      id: "q52",
      question: "What does the Arabic phrase 'وَأَهْلُ الْمَغْفِرَةِ' mean?",
      arabic: "وَأَهْلُ الْمَغْفِرَةِ",
      rootLetters: "أ ه ل | غ ف ر",
      options: [
        { id: "a", text: "And worthy of forgiveness", isCorrect: true },
        { id: "b", text: "And worthy of mercy", isCorrect: false },
        { id: "c", text: "And worthy of praise", isCorrect: false },
        { id: "d", text: "And worthy of honor", isCorrect: false },
      ],
      explanation: "وَأَهْلُ الْمَغْفِرَةِ (Wa ahl al-maghfirah) means 'And worthy of forgiveness,' roots أ-ه-ل (worthy) and غ-ف-ر (forgive) (MyIslam, Al-Maududi).",
    },
    {
      id: "q53",
      ...
      options: [
        { id: "a", text: "Say: Have you considered if your water becomes pure?", isCorrect: false },
        { id: "b", text: "Say: Have you considered if your water becomes deep?", isCorrect: true },
        { id: "c", text: "Say: Have you considered if your water becomes scarce?", isCorrect: false },
        { id: "d", text: "Say: Have you considered if your water becomes abundant?", isCorrect: false },
      ],
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "Then who could bring you flowing water?", isCorrect: false },
        { id: "b", text: "Then who could bring you pure water?", isCorrect: false },
        { id: "c", text: "Then who could bring you fresh water?", isCorrect: true },
        { id: "d", text: "Then who could bring you sweet water?", isCorrect: false },
      ],
